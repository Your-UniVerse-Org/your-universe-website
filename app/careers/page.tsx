    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, paddingTop: 120, paddingBottom: 120 }}>
        <div className="container" style={{ maxWidth: 760 }}>
          ...
          <h1 style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: "clamp(32px, 4vw, 52px)", fontWeight: 400, lineHeight: 1.1, letterSpacing: "-0.02em", color: "var(--text-1)", marginBottom: 32 }}>Careers</h1>
          <div style={{ display: "flex", flexDirection: "column", gap: 32, color: "var(--text-2)", fontSize: 16, lineHeight: 1.8, textAlign: "center" }}>
            <div style={{ padding: "48px 32px", background: "var(--surface)", borderRadius: 12, border: "1px solid var(--border)" }}>
              ...
              <p style={{ color: "var(--text-3)", marginBottom: 24 }}>
                We're building something special and we're looking for talented people to join us. Careers page coming soon!
              </p>
            ...
            <p style={{ fontSize: 14, color: "var(--text-3)" }}>
              For career opportunities at Lynxio Tech, visit{" "}
